...
document.getElementById("createTableNow").addEventListener("click", function() {
    document.getElementById("createTablePlaceholder").innerHTML = "";
    let caption = document.getElementById("caption").value;
    let rows = parseInt(document.getElementById("rows").value);
    let cols = parseInt(document.getElementById("cols").value);
    createTables(rows, cols, caption);
    document.getElementById("createTablePlaceholder").style.display = "block";
});
    ...
    document.getElementById("deleteTable").addEventListener("click", function() {
        ...
        document.getElementById("createTablePlaceholder").innerHTML = "";
        document.getElementById("createListPlaceholder").style.display = "none";
    });
